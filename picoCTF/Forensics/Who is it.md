...
## Giải 
- Bước đầu tiên tất nhiên là phải tải file xuống rồi
- Tiếp theo đọc file thôi :
```text
...
----_NmP-426c22a2e0d8fc9a-Part_1--
```
- Load sơ qua 1 tí ta thấy :
- Ip : `173.249.33.206`
- Mail: `lpage@onionmail.org`
- Tìm thông tin dựa trên ip :
- `whois 173.249.33.206`
- Nó sẽ liệt kê ra 1 số thông tin như tên đường, sđt, tên, etc...
- Dán tên người gửi vào khung picoCTF{} rồi submit
