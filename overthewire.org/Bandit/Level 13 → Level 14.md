...
```
- Kết quả trả về không có quyền truy cập cho key.txt vì quyền quá mở, trong khi chỉ có bạn mới được truy cập
- Sửa quyền 1 tí
>  chmod 700 key.txt
- 7 : 1-2-4 : Thực thi - Viết - Đọc  
- 0 : Không cấp quyền cho người dùng khác 
> ssh bandit14@bandit.labs.overthewire.org -p 2220 -i key.txt
- Ta đã vào được bandit14
